...
echo "  /nightshift-setup       — start a new run"
echo "  /nightshift-status      — check what it's doing"
echo "  /nightshift-review      — morning report"
echo "  /nightshift-resume      — pick up after a crash"
echo "  /nightshift-debug       — triage a failed task"
echo "  /nightshift-bulletproof — production hardening sweep"
echo ""
